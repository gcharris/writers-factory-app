That is an excellent approach to using an AI as a self-editing tool for detecting stylistic issues that could flag your creative prose as machine-generated. While the source material is explicitly a field guide for detecting AI-generated content on **Wikipedia**, it draws on observations about the **identifiable writing style** of Large Language Models (LLMs).

I will focus only on the indicators related to **content, language, grammar, and general style** that might manifest in creative prose, omitting technical markup, citation issues, and Wikipedia-specific formatting rules.

Here is a document that itemizes stylistic issues an AI reviewing your novel scenes or chapters should look for:
