This is the pivotal moment where we align the "Legacy Wisdom" (what worked before) with the "New Architecture" (Local-First).

To answer your question directly: **Version 2 is the one to keep.** Version 1 was the draft; Version 2 is the remediation.

However, you have now introduced a **third critical piece**: the `NOTEBOOKLM_INTEGRATION_RESEARCH.md`. This changes things significantly. My previous "Watch Folder" proposal was a conservative "safe" bet (manual export). But your research shows you **already successfully implemented an MCP (Model Context Protocol) Bridge** in the previous version.
...
Philosophy: Local-First, Graph-Driven, Context-Aware.
